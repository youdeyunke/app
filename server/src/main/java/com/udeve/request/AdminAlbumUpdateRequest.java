...
@Data
public class AdminAlbumUpdateRequest implements Serializable {
    @NotBlank(message = "分类名称不能为空")
    @Schema(description = "分类名称", example = "分类名称")
    public String name;
    @Schema(description = "分类key", example = "key")
    public String key;

    @Schema(description = "分类封面", example = "封面")
    public String cover;

    @Schema(description = "分类文案", example = "文案")
    ...
    @Schema(description = "是否能删除", example = "true")
