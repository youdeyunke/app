...
(
    ...
    `cdn_domain`                 varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'tcdn.udeve.net',
...
(
    ...
    `author_avatar` varchar(255)                                                  DEFAULT 'https://tcdn.udeve.net/default-avatar.png' COMMENT '作者头像',
